...
import {ComponentStyles, InputHeader, Text} from '@components';
...
export interface MultiDropDownListRef {
  clearSearch: () => void;
...
export const MultiDropDownList = forwardRef<MultiDropDownListRef, ListProps>(
  (
    {
      options,
      title,
